...
CREATE TABLE
  `products_extra_fields` (
    ...
    `products_extra_fields_order` int NOT NULL DEFAULT '0',
    ...
    `blank_rows` tinyint (1) NOT NULL DEFAULT '8',
    `default_names` text NOT NULL,
    PRIMARY KEY (`products_extra_fields_id`),
    KEY `products_extra_fields_order` (`products_extra_fields_order`),
    KEY `products_extra_fields_status` (`products_extra_fields_status`)
...
CREATE TABLE
  `products_to_products_extra_fields` (
    ...
    `products_extra_fields_id` int NOT NULL DEFAULT '0',
    `products_extra_fields_value` text NOT NULL,
    `products_extra_fields_image` text NOT NULL,
    `products_extra_fields_price` varchar(255) NOT NULL,
    `products_extra_fields_stock` varchar(255) NOT NULL,
    `parent_indices` varchar(255) NOT NULL DEFAULT '',
...
INSERT INTO
  `products_to_products_extra_fields` (
    ...
    `products_extra_fields_image`,
    `products_extra_fields_price`,
    `products_extra_fields_stock`,
    `parent_indices`
  )
VALUES
  (
