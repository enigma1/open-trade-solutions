...
DROP TABLE IF EXISTS `brands_description`;
...
DROP TABLE IF EXISTS `languages_strings`;
...
DROP TABLE IF EXISTS `products_specials`;
...
DROP TABLE IF EXISTS `products_to_brands`;
